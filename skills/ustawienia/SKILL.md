...
**Ta instrukcja pochodzi z wydania 0.32.3.** Numer jest wpisany w tym pliku, więc
...
Interesuje Cię `tag_name` (np. `v0.32.3`). Porównaj z numerem wyżej:
- **te same** → dopisz `Wersja: 0.32.3 (najnowsza)`.
- **wydanie nowsze** → dopisz `Wersja: 0.32.3 — jest już 0.32.4` i powiedz, jak
