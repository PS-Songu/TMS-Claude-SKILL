...
**Ta instrukcja pochodzi z wydania 0.32.2.** Numer jest wpisany w tym pliku, więc
...
Interesuje Cię `tag_name` (np. `v0.32.2`). Porównaj z numerem wyżej:
- **te same** → dopisz `Wersja: 0.32.2 (najnowsza)`.
- **wydanie nowsze** → dopisz `Wersja: 0.32.2 — jest już 0.32.3` i powiedz, jak
