...
**Ta instrukcja pochodzi z wydania 0.32.4.** Numer jest wpisany w tym pliku, więc
...
Interesuje Cię `tag_name` (np. `v0.32.4`). Porównaj z numerem wyżej:
- **te same** → dopisz `Wersja: 0.32.4 (najnowsza)`.
- **wydanie nowsze** → dopisz `Wersja: 0.32.4 — jest już 0.32.5` i powiedz, jak
